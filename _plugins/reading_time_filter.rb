...
module ReadingTimeFilter
    ...
    def _reading_time(input, second_plural, minute_singular, minute_plural)
      # Get words count.
    ...
    def reading_time(input)
        ...
        return _reading_time(input, second_plural, minute_singular, minute_plural)
    end

    def reading_time_brief(input)
        return _reading_time(input, "s", "min", "mins")
    end
